...
function openPlanDialog() { document.getElementById('plan-edit-id').value = ''; document.getElementById('plan-name').value = ''; document.getElementById('plan-image').value = ''; document.getElementById('plan-dialog-title').textContent = 'New Floor Plan'; document.getElementById('plan-dialog').classList.remove('hidden'); }
function closePlanDialog() { closeDialog('plan-dialog'); }
function editPlan(id) { const p = floorPlans.find(f => f.id === id); if (!p) return; document.getElementById('plan-edit-id').value = p.id; document.getElementById('plan-name').value = p.name; document.getElementById('plan-image').value = p.image_url || ''; document.getElementById('plan-dialog-title').textContent = 'Edit Floor Plan'; document.getElementById('plan-dialog').classList.remove('hidden'); }
...
function openRackDialog() { document.getElementById('rack-edit-id').value = ''; document.getElementById('rack-name').value = ''; document.getElementById('rack-units').value = 42; document.getElementById('rack-dialog-title').textContent = 'Add Rack'; document.getElementById('rack-dialog').classList.remove('hidden'); }
function editRack(id) { const r = racks.find(x => x.id === id); if (!r) return; document.getElementById('rack-edit-id').value = r.id; document.getElementById('rack-name').value = r.name; document.getElementById('rack-units').value = r.rack_units; document.getElementById('rack-dialog-title').textContent = 'Edit Rack'; document.getElementById('rack-dialog').classList.remove('hidden'); }
...
function openPanelDialog(rackId) { document.getElementById('panel-edit-id').value = ''; document.getElementById('panel-name').value = ''; document.getElementById('panel-ports').value = 24; document.getElementById('panel-position').value = 1; document.getElementById('panel-type').value = 'rj45'; const sel = document.getElementById('panel-rack'); sel.innerHTML = racks.map(r => `<option value="${r.id}" ${r.id===rackId?'selected':''}>${r.name}</option>`).join(''); document.getElementById('panel-dialog-title').textContent = 'Add Patch Panel'; document.getElementById('panel-dialog').classList.remove('hidden'); }
function editPanel(id) { const p = panels.find(x => x.id === id); if (!p) return; document.getElementById('panel-edit-id').value = p.id; document.getElementById('panel-name').value = p.name; document.getElementById('panel-ports').value = p.port_count; document.getElementById('panel-position').value = p.rack_position; document.getElementById('panel-type').value = p.panel_type; const sel = document.getElementById('panel-rack'); sel.innerHTML = racks.map(r => `<option value="${r.id}" ${r.id===p.rack_id?'selected':''}>${r.name}</option>`).join(''); document.getElementById('panel-dialog-title').textContent = 'Edit Patch Panel'; document.getElementById('panel-dialog').classList.remove('hidden'); }
