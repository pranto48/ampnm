...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $warning_latency_threshold = $_POST['warning_latency_threshold'] ?? 200;
    $warning_packetloss_threshold = $_POST['warning_packetloss_threshold'] ?? 25;
    $critical_latency_threshold = $_POST['critical_latency_threshold'] ?? 450;
    $critical_packetloss_threshold = $_POST['critical_packetloss_threshold'] ?? 80;
        ...
        try {
            ...
            if ($hasSubchoice) {
                ...
                $values = [
                    ...
                    empty($ping_interval) ? 20 : $ping_interval, $icon_size, $name_text_size,
                ...
                if ($hasTimeoutCols) {
                    $fields .= ", critical_offline_seconds = ?, offline_timeout_seconds = ?";
                    $values[] = $critical_offline_seconds;
                    $values[] = $offline_timeout_seconds;
                }
                if ($hasMonitoringMode) {
                    $fields .= ", monitoring_mode = ?, critical_packet_count = ?, offline_packet_count = ?";
            ...
            <form method="POST" action="edit-device.php?id=<?= (int)$device_id ?><?= isset($_GET['return']) ? '&return=' . urlencode($_GET['return']) : '' ?>" class="space-y-4">
                ...
                <fieldset class="border border-cyan-800/60 rounded-xl p-5 bg-slate-900/40 space-y-5 shadow-lg">
                    ...
                    <div class="space-y-2">
                        ...
                        <?php 
                            $current_mode = $form_data['monitoring_mode'] ?? 'time_threshold'; 
                        ?>
                    ...
                    <div id="section_time_threshold" class="bg-slate-950/70 p-4 rounded-xl border border-slate-800 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <input type="number" id="ping_interval" name="ping_interval" min="1" placeholder="20" class="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-2 text-sm text-white focus:ring-2 focus:ring-cyan-500" value="<?= htmlspecialchars($form_data['ping_interval'] ?? '20') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="critical_offline_seconds" name="critical_offline_seconds" min="1" placeholder="20" class="w-full bg-slate-900 border border-amber-600/50 rounded-lg px-3 py-2 text-sm text-white focus:ring-2 focus:ring-amber-500 font-semibold" value="<?= htmlspecialchars($form_data['critical_offline_seconds'] ?? '20') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="offline_timeout_seconds" name="offline_timeout_seconds" min="1" placeholder="30" class="w-full bg-slate-900 border border-red-600/50 rounded-lg px-3 py-2 text-sm text-white focus:ring-2 focus:ring-red-500 font-semibold" value="<?= htmlspecialchars($form_data['offline_timeout_seconds'] ?? '30') ?>">
                    ...
                    <div id="section_packet_count" class="bg-slate-950/70 p-4 rounded-xl border border-slate-800 space-y-3">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" id="critical_packet_count" name="critical_packet_count" min="1" placeholder="20" class="w-full bg-slate-900 border border-amber-600/50 rounded-lg px-3 py-2 text-sm text-white focus:ring-2 focus:ring-amber-500 font-semibold" value="<?= htmlspecialchars($form_data['critical_packet_count'] ?? '20') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="offline_packet_count" name="offline_packet_count" min="1" placeholder="30" class="w-full bg-slate-900 border border-red-600/50 rounded-lg px-3 py-2 text-sm text-white focus:ring-2 focus:ring-red-500 font-semibold" value="<?= htmlspecialchars($form_data['offline_packet_count'] ?? '30') ?>">
                    ...
                    <div id="performance_thresholds_container" class="bg-slate-950/70 p-4 rounded-xl border border-slate-800 space-y-3 transition-all duration-300">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4" id="threshold_inputs_grid">
                            <div>
                                ...
                                <input type="number" id="warning_latency_threshold" name="warning_latency_threshold" class="threshold-input w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['warning_latency_threshold'] ?? '200') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="warning_packetloss_threshold" name="warning_packetloss_threshold" class="threshold-input w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['warning_packetloss_threshold'] ?? '25') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="critical_latency_threshold" name="critical_latency_threshold" class="threshold-input w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['critical_latency_threshold'] ?? '450') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="critical_packetloss_threshold" name="critical_packetloss_threshold" class="threshold-input w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['critical_packetloss_threshold'] ?? '80') ?>">
