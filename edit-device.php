                    ...
                    <div class="bg-slate-950/70 p-4 rounded-xl border border-slate-800 space-y-3">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="number" id="warning_latency_threshold" name="warning_latency_threshold" class="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['warning_latency_threshold'] ?? '200') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="warning_packetloss_threshold" name="warning_packetloss_threshold" class="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['warning_packetloss_threshold'] ?? '25') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="critical_latency_threshold" name="critical_latency_threshold" class="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['critical_latency_threshold'] ?? '450') ?>">
                            ...
                            <div>
                                ...
                                <input type="number" id="critical_packetloss_threshold" name="critical_packetloss_threshold" class="w-full bg-slate-900 border border-slate-700 rounded-lg px-3 py-1.5 text-sm text-white" value="<?= htmlspecialchars($form_data['critical_packetloss_threshold'] ?? '80') ?>">
