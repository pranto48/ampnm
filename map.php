    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div id="map-container" class="hidden">
            ...
            <div id="network-map-wrapper">
                ...
                <div id="connection-legend" class="absolute bottom-4 right-4 bg-slate-800/90 backdrop-blur-sm border border-slate-700 rounded-lg p-4 shadow-xl hidden select-none z-10 transition-all duration-200">
                    <div class="flex items-center justify-between mb-3 border-b border-slate-700/60 pb-2">
                        <h3 class="text-sm font-semibold text-white flex items-center cursor-move">
                            <i class="fas fa-project-diagram mr-2 text-cyan-400"></i>
                            Connection Types
                        </h3>
                        <button id="fixConnLegendBtn" class="px-1.5 py-0.5 rounded text-[11px] font-medium border border-transparent text-slate-400 hover:text-cyan-400 transition-all flex items-center gap-1" title="Fix / Lock Position with Zoom (জুমের সাথে পজিশন ফিক্স করুন)">
                            <i id="fixConnLegendIcon" class="fas fa-thumbtack"></i>
                            <span id="fixConnLegendText" class="hidden sm:inline">Fix Pos</span>
                        </button>
                    </div>
