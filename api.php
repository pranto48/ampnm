...
try {
    ...
    $deviceActions = [
        ...
        'get_synthetic_monitors', 'create_synthetic_monitor', 'delete_synthetic_monitor', 'test_synthetic_monitor_live', 'run_all_synthetic_monitors',
        ...
        'get_agent_software', 'get_agent_security_health'
    ];
