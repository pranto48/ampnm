        ...
        <div className="grid gap-12 lg:grid-cols-12 items-stretch">
          ...
          <div className="lg:col-span-5 space-y-8 flex flex-col justify-between">
            <div className="space-y-6">
              <h3 className="text-lg font-bold text-white uppercase tracking-wider">Contact Coordinates</h3>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-zinc-900 bg-zinc-900/10 p-5 space-y-3 flex flex-col justify-end h-48 select-none">
          ...
          <div className="lg:col-span-7 bg-zinc-900/30 border border-zinc-900 p-6 sm:p-8 rounded-3xl relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <h3 className="text-lg font-bold text-white uppercase tracking-wider mb-2">Request Assistance</h3>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-zinc-950 border border-zinc-900 rounded-xl text-xs font-semibold text-zinc-200 focus:outline-none focus:ring-2 focus:ring-blue-500"
                  />
                </div>
