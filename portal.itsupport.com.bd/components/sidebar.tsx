...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { name: "Network Devices", href: "/devices", icon: Cpu },
    { name: "Alert Feeds", href: "/alerts", icon: BellRing },
    { name: "License Management", href: "/licenses", icon: FileText },
  ...
  return (
    ...
    >
      ...
      <div className="h-16 flex items-center justify-between px-4 border-b border-zinc-200 dark:border-zinc-800">
        <Link href="/" className="flex items-center gap-3 overflow-hidden focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 rounded-lg">
      ...
      {/* Footer section (toggle button when collapsed) */}
      {!sidebarOpen && (
