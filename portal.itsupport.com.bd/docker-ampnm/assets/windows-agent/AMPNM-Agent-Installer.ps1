...
.PARAMETER ServerUrl
    The full URL to the AMPNM metrics endpoint (e.g., http://192.168.1.100:2266/api.php?action=submit_metrics)
...
.EXAMPLE
    .\AMPNM-Agent-Installer.ps1 -ServerUrl "http://192.168.1.100:2266/api.php?action=submit_metrics" -AgentToken "your-token-here"
...
if (-not $ServerUrl) {
    ...
    Write-Host "  Install: .\AMPNM-Agent-Installer.ps1 -ServerUrl 'http://your-server:2266/api.php?action=submit_metrics' -AgentToken 'your-token'" -ForegroundColor Gray
